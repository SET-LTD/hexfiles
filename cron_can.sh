...
screen -S dmsg -X stuff 'while true; do clear; dmesg | tail -n 100; sleep 4; done'
screen -S dmsg -X stuff '\015'
screen -S ifconfx -X stuff 'while true; do clear; sudo ifconfig; sleep 0.5; done'
screen -S ifconfx -X stuff '\015'
screen -S ipdet -X stuff 'while true; do clear; sudo ip -det -stat link show can0; sleep 0.5; done'
